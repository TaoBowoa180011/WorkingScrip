...
for root,dir,files in os.walk(filename):
    for d in  tqdm(dir):
        ...
        orign_lid=[]
        orign_sink=[]
        dstfolder_list=[dstfolder+'picture/',dstfolder+'txt/','location_dataset/sink/picture/','location_dataset/sink/txt/']
        ...
        for lid_output in mse_lid_list_same+mse_lid_list_diff:
            print("cp /home/zhen/PycharmProjects/pythonProject/"+filename+d+'/obj_train_data/'+lid_output[2]+
                              " /home/zhen/PycharmProjects/pythonProject/"+dstfolder+'picture/'+d+'_'+lid_output[2])
            ...
            print("cp /home/zhen/PycharmProjects/pythonProject/" + filename + d + '/obj_train_data/' + lid_output[2][:-4]+'.txt' +
                      " /home/zhen/PycharmProjects/pythonProject/" + dstfolder + 'txt/'+d +'_'+ lid_output[2][:-4]+'.txt')
